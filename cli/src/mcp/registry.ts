...
export const toolRegistry: ToolMetadata[] = [
  ...
  },
  {
    ...
    description: 'List all checklist items for a draft task, including downstream tasks',
    category: 'tasks',
  ...
  },
  {
    ...
    description: 'Update a draft checklist item (mark complete, rename, reposition)',
    category: 'tasks',
  ...
  {
    name: 'reorder_draft_items',
    description: 'Reorder all checklist items in a draft task by providing item IDs in desired order',
    category: 'tasks',
    keywords: ['draft', 'checklist', 'reorder', 'sort', 'move', 'position'],
    defer_loading: true,
  },
  {
    name: 'batch_update_draft_items',
    description: 'Batch update multiple draft checklist items at once',
    category: 'tasks',
    keywords: ['draft', 'checklist', 'batch', 'update', 'bulk', 'complete'],
    defer_loading: true,
  },
  {
