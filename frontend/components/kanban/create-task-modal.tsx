...
export function CreateTaskModal({ open: controlledOpen, onOpenChange, defaultRepository, showTrigger = true }: CreateTaskModalProps = {}) {
  ...
  useEffect(() => {
    ...
    // If baseBranch is already a remote ref (e.g. origin/main), use it directly
    ...
    createTask.mutate(
      {
        ...
        pullToLatest: shouldStartWork ? pullToLatest : undefined,
        pullRemoteBranch: shouldStartWork && pullToLatest ? (pullRemoteBranch || undefined) : undefined,
